...
<html lang="en">
	...
	<div class="header">
		...
		<div class="row">
			...
			<center>
				<h1>සිංහල පොත්</h1>
				<p>“ඔබ කියවන තරමට, ඔබ වැඩි වැඩියෙන් දේවල් දැන ගනු ඇත. <br>ඔබ වැඩි වැඩියෙන් ඉගෙන ගන්නා තරමට, ඔබ වැඩි වැඩියෙන් තැන්වලට යනු ඇත.”</p>
				</center>
			</div>
			<div>
				<img src="sinhala.png" width="400px">
			</div>
			</div>
	...
	<!--- book CATEGORY---->
		...
		<div class="small-container">
			<h2 class="title">SINHALA BOOKS</h2>
				<div class="small-container">
					<div class= "row">
						<div class="col-4">
							<img src="Thriller1.jfif">
